...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        changeGrammage: function changeGrammage(indexProductList, indexProduct) {
        ...
        changeFormat: function changeFormat(indexProductList, indexProduct) {
        ...
        setProductSettings: function setProductSettings(indexProductList, item) {
            var product = this.products.brand[item.brand].grammage[item.grammage].format[item.format];
            conole.log(item);
            this.productList[indexProductList].id = product.id;
            this.productList[indexProductList].min_lot = product.min_lot;
        },
        itemVolume: function itemVolume(indexProductList) {
            var itemVolume = 0;
        ...
        calcPrice: function calcPrice(indexProductList) {
            var price = 0;
...
Component.options.__file = "resources\\assets\\js\\components\\ConsigneerComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c04bd3a", Component.options)
  } else {
    hotAPI.reload("data-v-7c04bd3a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "flex receivers" }, [
    _c("div", { staticClass: "receivers__col receivers__col-left" }, [
      _vm.showSelect
        ? _c("div", [
            _c("div", { staticClass: "receiver-title" }, [
              _vm._v("Выберите грузополучателя")
            ]),
            _vm._v(" "),
            _c(
              "select",
      ...
      _vm._v(" "),
      _c("div", { staticClass: "nm-address" }, [
        _vm._v("\n            " + _vm._s(_vm.selected.address) + "\n        ")
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "flex banking" }, [
        _c("div", { staticClass: "banking__item" }, [
          _c("span", { staticClass: "banking__title" }, [_vm._v("ИНН:")]),
          _vm._v(
            "\n                " + _vm._s(_vm.selected.INN) + "\n            "
          )
        ]),
        _vm._v(" "),
        _c("div", { staticClass: "banking__item" }, [
          _c("span", { staticClass: "banking__title" }, [_vm._v("КПП:")]),
          _vm._v(
            "\n                " + _vm._s(_vm.selected.KPP) + "\n            "
          )
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "info-line-small" }, [
        _vm._v("Диаметр рулона: "),
        _c("span", { staticClass: "info-line-small__color" }, [
          _vm._v(_vm._s(_vm.selected.roll_diameter))
        ])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "info-line-small" }, [
        _vm._v("Диаметр гильзы: "),
        _c("span", { staticClass: "info-line-small__color" }, [
          _vm._v(_vm._s(_vm.selected.core_diameter))
        ])
      ])
    ]),
    _vm._v(" "),
    !_vm.showProducts
      ? _c("div", { staticClass: "receiver-title" }, [
          _vm._v("Нет данных о номенклатуре")
        ])
      : _c(
          "div",
          { staticClass: "receivers__col receivers__col-right" },
          _vm._l(_vm.products, function(product) {
            return _c("div", { staticClass: "infoblocks" }, [
              _c("div", { staticClass: "infoblock flex" }, [
                _c("div", { staticClass: "infoblock__col" }, [
                  _c(
                    "div",
                    { staticClass: "info-title infoblock__info-title" },
                    [_vm._v("Данные о грузе")]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "info-line-small" }, [
                    _vm._v("Марка: "),
                  ...
                  _c("div", { staticClass: "info-line-small" }, [
                    _vm._v("Граммаж: "),
                    _c("span", { staticClass: "info-line-small__color" }, [
                      _vm._v(_vm._s(product.grammage))
                    ])
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "info-line-small" }, [
                ...
                _c("div", { staticClass: "infoblock__col" }, [
                  _c(
                    "div",
                    { staticClass: "info-title infoblock__info-title" },
                    [_vm._v("Объём продукции")]
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "info-line-small" }, [
                    _vm._v("Минимальная партия: "),
                    _c("span", { staticClass: "info-line-small__color" }, [
                      _vm._v(_vm._s(product.min_lot) + " т")
                    ])
                  ])
                ]),
                _vm._v(" "),
                _c(
                  ...
                  [
                    ...
                    _vm._v(" "),
                    _vm._l(product.deliveries, function(delivery) {
                      return _c("div", { staticClass: "info-line-small" }, [
                        _vm._v(
                        ...
                        _c("span", { staticClass: "info-line-small__color" }, [
                          ...
                          _c("span", { staticClass: "rouble" }, [_vm._v("q")])
                        ])
                      ])
                    })
                  ],
...
Component.options.__file = "resources\\assets\\js\\components\\FileuploadComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a15b9f4e", Component.options)
  } else {
    hotAPI.reload("data-v-a15b9f4e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm._l(_vm.files, function(upload) {
        return _c("div", { staticClass: "document document_flex" }, [
          _c("span", { staticClass: "document__title" }, [
            _vm._v("Документ-рейс")
          ]),
          _vm._v("\n            " + _vm._s(upload.name) + "\n        "),
          _c("div", { staticClass: "document__links" }, [
            _c(
              "a",
              { staticClass: "document__link", attrs: { href: upload.path } },
              [_vm._v("Скачать")]
            )
          ])
        ])
      ...
      _vm._v(" "),
      _c("div", { staticClass: "document document_upload" }, [
...
Component.options.__file = "resources\\assets\\js\\components\\SelectProduct.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-57736628", Component.options)
  } else {
    hotAPI.reload("data-v-57736628", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_node_modules_vue_loader_lib_selector_type_script_index_0_SelectProducts_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8fa21c92_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SelectProducts_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_8fa21c92_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SelectProducts_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources\\assets\\js\\components\\SelectProducts.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8fa21c92", Component.options)
  } else {
    hotAPI.reload("data-v-8fa21c92", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-8fa21c92", { render: render, staticRenderFns: staticRenderFns })
  }
}
