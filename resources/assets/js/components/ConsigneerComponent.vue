...
<div class="receivers__col receivers__col-left">
					...
					<div class="info-line-small">Диаметр рулона: <span class="info-line-small__color">{{ selected.roll_diameter}}</span></div>
					<div class="info-line-small">Диаметр гильзы: <span class="info-line-small__color">{{ selected.core_diameter}}</span></div>
				</div>
